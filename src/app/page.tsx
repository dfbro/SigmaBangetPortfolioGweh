            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <div className="relative p-0.5 group">
                <GlowingEffect
                  ...
                  glow={true}
                />
                <Button size="lg" className="relative bg-primary text-primary-foreground hover:bg-primary/90 rounded-none h-14 px-8 font-headline font-bold shadow-[0_0_20px_rgba(34,197,94,0.3)]" asChild>
                  <Link href="/ctf">
              ...
              <div className="relative p-0.5 group">
                <GlowingEffect
                  ...
                  glow={true}
                />
                <Button size="lg" variant="outline" className="relative border-secondary text-secondary hover:bg-secondary/10 rounded-none h-14 px-8 font-headline font-bold bg-background/50" asChild>
              ...
              <div className="relative p-0.5 group">
                <GlowingEffect
                  ...
                  glow={true}
                />
                <Button size="lg" variant="ghost" className="relative text-muted-foreground hover:text-primary hover:bg-primary/5 rounded-none h-14 px-8 font-headline font-bold flex items-center gap-2 bg-background/50" asChild>
                  <Link href="/about">
